...
vox$annee_cat <- cut(vox$annee, seq(from = 1981, to = 2016, by = 4), right = FALSE, include.lowest = TRUE)
...
vox_regression_greens <- readRDS("/master-thesis/data/regression_results/vox_regression_greens.rds")

vox_regression_noparty <- readRDS("/master-thesis/data/regression_results/vox_regression_noparty.rds")

vox_regression_pdc <- readRDS("/master-thesis/data/regression_results/vox_regression_pdc.rds")

vox_regression_plr <- readRDS("/master-thesis/data/regression_results/vox_regression_plr.rds")

vox_regression_ps <- readRDS("/master-thesis/data/regression_results/vox_regression_ps.rds")

vox_regression_udc <- readRDS("/master-thesis/data/regression_results/vox_regression_udc.rds")
```
