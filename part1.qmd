...
A series of binary logit regressions for party support, political leaning, opinion on redistribution, state intervention and equal rights between Swiss and foreigners are run. The results presented in this section come essentially from the following model:
