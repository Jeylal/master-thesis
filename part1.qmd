...
Overall, the regression analysis conducted in this section, using a different data source from the WPID project and from Oesch and Rennwald, offer a new way to describe the evolution of the Swiss social blocs, which is summarized in @tbl-socialblocs3. However, this analysis suffers from several limitations.
...
$$P(y_{1},...,y_{t}) = \sum^c_{c = 1} P(X = c) \prod^T_{t=1} P(y_{t} | X = c)$$ {#eq-lca}

With $P(y_{1},...,y_{t})$ the joint probability to observe a response pattern to a set of questions $T$ taken as indicators. $P(X = c)$ is the probability to belong to cluster $c$ of the discrete latent variable $X$. The association between the latent class variable $X$ and the indicators $t$ is estimated through binary logistic regression (if the indicators are dichotomous) or, in our case, through multinomial logistic regression (if the indicators have more than two unordered categories).

An important step of LCA is model selection, that is, choosing the model with the appropriate number of clusters. The criteria chosen to determine the number of clusters in this section is a bootstrap likelihood ratio test, an indicator which, according to @nylund_deciding_2007, is the most suited compared to information criteria (AIC, BIC...). A series of models are thus estimated, increasing the number of clusters with each new model until the bootstrap likelihood ratio test showed no significance of adding a supplementary cluster to the model[^part1-1].

[^part1-1]: The models were estimated with the statistical software *LatentGOLD*.

### Estimation of Swiss socio-political groups in 1999: the 12 clusters model

For the first LCA estimation, the Swiss post-electoral study of 1999 [@hardmeier_befragung_2022] was chosen. The reasons behind this choice are technical, but first and foremost historical as the 90s represent a turning point in Swiss history and the evolution of the Swiss social blocs.

As explained in section 2.1, the Swiss socio-political landscape was structured around two social blocs before the 90s: a dominant liberal-conservative and a subordinate left bloc. These two blocs were able to cooperate in what Pietro Boschetti famously called the Swiss variant of the "historical compromise" between the Swiss left and right-wing parties. On the one hand, the PLR, PDC and Agrarian parties were willing to cooperate with the Swiss Socialist party and develop social security to a certain extent. On the other hand, the Swiss Socialist party abandoned its anti-capitalist stances and became a moderate social-democrat reformist party aimed at promoting the creation of a Swiss welfare state, increase in real wage and promote the public sector and employment protection [@boschetti_conquete_2007].
...
One interesting question is about the opinion on Swiss army, which asked whether the respondent preferred a strong army or no army at all. This question is relevant regarding the historical context since the 90s represented a turbulent period for the Swiss army. In 1986, the *Group for a Switzerland without an army* launched a popular initiative called *For a Switzerland Without an Army and an Overall Peaceful Political Stance* which, three years later, unexpectedly gathered 35.5% positive votes with a majority of yes in two cantons: Jura (55.5%) and Geneva (50.4%). These stunning results (no one would have expected such a high share of yes) greatly disturbed the government and the Swiss army, and the latter underwent a process of important reforms thereafter. Despite the rejection of this initiative, the debate over the role and the future of the Swiss army was still very heated in the late 90s.

Another question is about European integration. In surely of the most important and disputed referendum in Swiss history, Swiss citizen were to vote on their country's adhesion to the European Economic Area (EEA) in 1992. As in other European countries, European integration became an important cleavage which destabilized both the liberal-conservative and left blocs. In the former, the UDC was the only major party to oppose the adhesion, while, in the latter, the Swiss Socialist party and labor unions were strongly in favor, with the exception of the Greens. This party was however divided over this issue, with a cleavage between the German-speaking cantons which strongly opposed the adhesion while the French-speaking cantons were in favor. The attitude towards European integration was included to assess the extent to which Switzerland displays a similar pattern than France in terms of European integration cleavage and the break-up of the traditional social blocs. As underlined by @amable_illusion_2018, @amable_structural_2017, European integration played an important role in the break-up of the traditional left and right blocs in France. The popular groups of the two blocs tended to opposed European integration while the most skilled and wealthiest elements were united around the pursuit of EU integration, which is one of the main policy demand of the bloc bourgeois, along with neoliberal reforms and progressive "cultural attitude".
...
The two last questions concern "cultural" issues: attitude towards Swiss traditions and foreigners. The former asked whether the respondents whether they preferred Swiss traditions or modernity. The latter asked whether the respondents whether they were in favor of unequal rights between Swiss citizen and foreigners and better chances for the Swiss or equal rights and chances. Switzerland stands out for its high proportion of foreigners who have less rights than Swiss citizen. During the Post-war period, Switzerland became a country of immigration due to high sustained growth and labor shortages. Immigrants were mainly seasonal workers on temporary residence permits, with no right to family reunification and no voting rights. They were expelled as soon as their labor force was no longer needed. It is often said that, in this way, Switzerland maintain full employment by exporting its unemployed foreign labor force. As soon as the Swiss economy overheated in the late 60s, restrictive immigration policies were adopted, while certain rights for foreign residents were improved, under pressure from negotiations with neighboring countries (Piguet 2004). Including these two cultural issue positions variables are important to situate the socio-political groups on the so-called "cultural" cleavage, which may be important to assess the transformations of the traditional Swiss social blocs.

#### Description of the 12 clusters model

+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| Cluster       | Weight                | Policy Preferences                                                                                                                     | Characteristics                               |
+===============+=======================+========================================================================================================================================+===============================================+
| 1             | 17,8%\                | For increase in social spending and in taxes on high income (HI). Rather free market.                                                  | Rather middle-aged and old.                   |
|               |                       |                                                                                                                                        |                                               |
|               |                       | No clear opinion on Swiss army.                                                                                                        | Female, low income, low and middle education. |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Rather pro-EU integration, but with an appreciable minority of anti-EU supporters (40%)                                                | Protestant, urban, German.                    |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For equal chances Swiss-foreigners, but defend traditions.                                                                             |                                               |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Rather pro-environment and against nuclear energy.                                                                                     |                                               |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 2             | 13,7%                 | Strongly against neoliberal policies (against reducing social spending, taxes on HI).                                                  | Young, female,                                |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For no Swiss army. Strongly pro-EU integration.                                                                                        | high income, High education,                  |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For equal chances Swiss-CH and culturally progressive.                                                                                 | French-speaking, urban.                       |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Srongly pro-environment and against nuclear energy.                                                                                    |                                               |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 3             | 13,4%                 | Against social spending, for taxes on HI, rather free-market.                                                                          | Rather old, female,                           |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For a strong Swiss army.                                                                                                               | low income,                                   |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Against EU integration.                                                                                                                | low education, unskilled workers,             |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For better chances for the Swiss, culturally conservative.                                                                             | craft specialists, self-employed,             |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Pro-environment and against nuclear energy.                                                                                            | Protestant, German and Italian Speaking,      |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | rural.                                        |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 4             | 12,4%                 | In favor of social spending and taxes HI, but rather free-market.                                                                      | Young, female,                                |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Divided over Swiss army, but with a majority of no army supporters (46%).                                                              | middle-high income and education,             |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Pro-EU integration.                                                                                                                    | skilled workers and managers,                 |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For equal chances Swiss-foreigners, but divided over tradition vs modernity.                                                           | catholics or no religion, urban.              |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For environment protection and against nuclear energy.                                                                                 |                                               |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 5             | 7,1%                  | Against social spending and state intervention, but for taxes HI.                                                                      | Rather old,                                   |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For strong army.                                                                                                                       | Male,                                         |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Against EU-integration.                                                                                                                | middle-low income and education,              |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For better chances for the Swiss, culturally conservative.                                                                             | protestant, German speaking,                  |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Divided over environment vs growth, for nuclear energy.                                                                                | rural.                                        |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 6             | 6,9%                  | No opinion on social spending, no opinion or rather in favor of taxes HI and free market.                                              | Rather old, high income, high education,      |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Pro-EU integration.                                                                                                                    | vocational training,                          |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For equal chances Swiss-foreigners, rather defend traditions. For nuclear energy                                                       | managers, skilled employees,                  |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | retired, German-speaking,                     |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | urban.                                        |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 7             | 6,9%                  | For higher taxes on HI. For strong army.                                                                                               | Old, low income,                              |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Pro-EU integration.                                                                                                                    | low education,                                |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For equal chances Swiss-foreigners and defend traditions.                                                                              | protestant, craft specialists,                |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Against nuclear energy.                                                                                                                | skilled and unskilled employees,              |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | managers,                                     |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | German-speaking,                              |
...
|               |                       |                                                                                                                                        | rural.                                        |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 8             | 5,9%                  | For increase in social spending and taxes on HI.                                                                                       | Rather young,                                 |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For no army.                                                                                                                           | female,                                       |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Pro-EU integration.                                                                                                                    | high income,                                  |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For equal chances Swiss-foreigners and question traditions.                                                                            | high education,                               |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Rather pro-environment and against nuclear energy.                                                                                     | skilled workers, managers,                    |
|               |                       |                                                                                                                                        |                                               |
...
|               |                       |                                                                                                                                        | no religion, urban.                           |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 9             | 4,9%                  | Against social spending and taxes on HI, strongly for free-markets.                                                                    | Old, male, high income,                       |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For strong army.                                                                                                                       | rather high education,                        |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Against EU-integration.                                                                                                                | protestant, self-employed,, German-speaking,  |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Rather for better chances for the Swiss and defend traditions.                                                                         |                                               |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Divided on environment vs growth, pro-nuclear energy.                                                                                  |                                               |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 10            | 4.9%                  | Against social spending and taxes on HI, strongly for free markets.                                                                    | Young, male, high income,                     |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For strong army, but with a appreciable minority of no army supporters (37%).                                                          | high education,                               |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For EU-integration.                                                                                                                    | managers, skilled workers,                    |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For equal chances Swiss-foreigners, question traditions.                                                                               | self-employed,                                |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Rather for economic growth and nuclear energy.                                                                                         | German-speaking, urban.                       |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 11            | 3,3%                  | Against EU-integration. For better chances for the Swiss and defend traditions. For environment protection and against nuclear energy. | Old, female,                                  |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | low income, middle-education,                 |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | skilled and unskilled workers,                |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | protestant.                                   |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
| 12            | 2,6%                  | For increase in social spending and taxes HI and state intervention.                                                                   | Rather old, female,                           |
|               |                       |                                                                                                                                        |                                               |
|               |                       | Rather for no army.                                                                                                                    | low income,                                   |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For better chances for the Swiss and defend traditions.                                                                                | low education,                                |
|               |                       |                                                                                                                                        |                                               |
|               |                       | For environment protection, against nuclear energy.                                                                                    | unskilled workers,                            |
|               |                       |                                                                                                                                        |                                               |
|               |                       |                                                                                                                                        | socio-cultural specialists.                   |
+---------------+-----------------------+----------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+

: Cluster description {#tbl-clusters}
