...
reg_ps <- glm(data = na.omit(vox[c("pss","incomef","educationf","annee_cat","gender","age_cat","religion","regionL")]), pss ~ incomef:annee_cat + educationf:annee_cat + annee_cat + gender + age_cat + religion + regionL, family = binomial(link = "logit"))

reg_plr <- glm(data = na.omit(vox[c("plr","incomef","educationf","annee_cat","gender","age_cat","religion","regionL")]), plr ~ incomef:annee_cat + educationf:annee_cat + annee_cat + gender + age_cat + religion + regionL, family = binomial(link = "logit"))

reg_pdc <- glm(data = na.omit(vox[c("pdc_pcs","incomef","educationf","annee_cat","gender","age_cat","religion","regionL")]), pdc_pcs ~ incomef:annee_cat + educationf:annee_cat + annee_cat + gender + age_cat + religion + regionL, family = binomial(link = "logit"))

reg_udc <- glm(data = na.omit(vox[c("udc","incomef","educationf","annee_cat","gender","age_cat","religion","regionL")]), udc ~ incomef:annee_cat + educationf:annee_cat + annee_cat + gender + age_cat + religion + regionL, family = binomial(link = "logit"))

reg_greens <- glm(data = na.omit(vox[c("green","incomef","educationf","annee_cat","gender","age_cat","religion","regionL")]), green ~ incomef:annee_cat + educationf:annee_cat + annee_cat + gender + age_cat + religion + regionL, family = binomial(link = "logit"))

reg_abstention <- glm(data = na.omit(vox[c("no_party","incomef","educationf","annee_cat","gender","age_cat","religion","regionL")]), no_party ~ incomef:annee_cat + educationf:annee_cat + annee_cat + gender + age_cat + religion + regionL, family = binomial(link = "logit"))

library(mvord)

reg_lr <- polr(data = voxlr, lr ~ income + education + annee_cat, Hess = TRUE)
summary(reg_lr)
