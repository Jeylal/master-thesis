...
comp_ps <- 
  vox_regression_ps %>% 
  avg_comparisons(variables = list(educationf = c("voc_training", "University"), incomef = c("low", "high")), by = c("annee_f", "canton"))
