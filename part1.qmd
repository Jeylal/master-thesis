...
clustertable <- read_excel(sheet = 7, "F:/master-thesis/lca estimations/selects1999_lcaresults.xlsx")
clustertable_html <- 
clustertable %>% 
  gt() # use gt-save() to save if needed


include_graphics("F:/master-thesis/data/clustertable.png")
```
