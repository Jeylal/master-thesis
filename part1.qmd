...
#| fig-height: 5
ame_IP <- readRDS("/master-thesis/data/ame/ame_IP.rds")
ame_parties <- readRDS("/master-thesis/data/ame/ame_parties.rds")
ame_polleaning <- readRDS("/master-thesis/data/ame/ame_polleaning.rds")
...
step3lr <- read_excel(sheet = 6, "F:/master-thesis/lca estimations/selects1999_lcaresults.xlsx")
