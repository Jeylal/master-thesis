...
#| message: false
#| label: fig-manifesto
#| fig-cap: "Positions of the Swiss Socialist Party on Planned Economy, the Welfare State and on an Overall Left-Right Scale."
#| fig-width: 9
#| fig-height: 6
...
manifesto %>% 
  ...
  geom_point()+
  theme_minimal()+
  labs(x = "", title = "Welfare", y = "", caption = "Note: the higher the values, the more the party favors a planned economy (left) and the welfare state (right)")+
