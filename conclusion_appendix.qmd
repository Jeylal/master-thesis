...
#| message: false
#| echo: false
#| tbl-cap: "Binary logit regressions: party support (PS, Greens, No party)"
#| label: tbl-summarylogitpartiesleft

huxreg("PS" = reg_ps, "Greens" = reg_greens, "No Party" = reg_abstention)
huxreg("PRD-PLR" = reg_plr, "PDC/PCS" = reg_pdc, "UDC" = reg_udc)
```
...
#| message: false
#| echo: false
#| tbl-cap: "Binary logit regressions: party support (PRD-PLR, PDC-PCS, UDC)"
...
#| message: false
#| echo: false
#| tbl-cap: "Binary logit regressions: political leaning"
#| label: tbl-summarylogitleaning

huxreg("Left" = reg_left, "Right" = reg_right, "No leaning" = reg_center)
...
#| message: false
#| echo: false
#| tbl-cap: "Binary logit regressions: issue position"
#| label: tbl-summarylogitIP
huxreg("Redistribution" = reg_redistr, "Equal rights & chances CH-foreign" = reg_equal_rights_chforeign, 
       "State intervention" = reg_state)
```
...
#| message: false
#| include: false
load("C:/Users/celal/OneDrive/Bureau/master-thesis/saved_models/glmer_greens.rda")
load("C:/Users/celal/OneDrive/Bureau/master-thesis/saved_models/glmer_pdc_pcs.rda")
load("C:/Users/celal/OneDrive/Bureau/master-thesis/saved_models/glmer_plr.rda")
load("C:/Users/celal/OneDrive/Bureau/master-thesis/saved_models/glmer_ps.rda")
load("C:/Users/celal/OneDrive/Bureau/master-thesis/saved_models/glmer_udc.rda")


tab_model(glmer_pss, glmer_pdc_green, glmer_pdc_pcs, glmer_plr, glmer_udc, dv.labels = c("PS", "Greens", "PDC/PCS", "PRD-PLR", "UDC"), file = "glmer_table.html")

webshot::webshot("C:/Users/celal/OneDrive/Bureau/master-thesis/glmer_table.html", file = "glmer_table.png")
