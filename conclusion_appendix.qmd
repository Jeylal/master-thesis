...
#| fig-cap: "Proportions of Swiss citizen's support for the country's main parties: 1981:2016"

plot_models(descreg_ps, descreg_udc, descreg_plr, descreg_noparty, descreg_greens, descreg_pdc, legend.title = "")+theme_bw()+coord_cartesian()+scale_x_discrete(limits = rev, labels = 1981:2016)+theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1), legend.position = c(0.85, 0.8), legend.background = element_blank())+ylim(0, 0.6)+labs(y = "", caption = "Source: VoxIt")+guides(color=guide_legend(nrow=3))
