...
#| message: false
#| warning: false
#| tbl-cap: "Binary logistic regression: support for EU integration. Log(odds). Data source: SELECTS 1999 data."
#| label: tbl-eu
...
modelsummary(list("Support EU integration" = regeu), stars = TRUE,
             notes = "Income is a 11 categories income bracket variable. Education is the highest achieved education level of the respondent, from primary school to university.")
```
