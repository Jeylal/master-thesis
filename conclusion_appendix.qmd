...
modelsummary(list("For EU integration" = regeu), stars = TRUE,
             notes = "Income is a 11 categories income bracket variable. Education is the highest achieved education level 
             of the respondent, from primary school to university.")
```
