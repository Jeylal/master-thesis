...
::: {.column width="30%"}
![](image_workshop/amable2017.jpeg){width="178"}

![](image_workshop/lastneoliberal.jpg){width="147"}
:::
:::
...
## Foundation of a neorealist approach {.r-fit-text}
...
## Left bloc strategy: The Gurten Manifesto {.smaller}
...
## On the right: SVP's winning strategy

::: columns
::: column
![](docs/part1_files/figure-html/fig-partystrength-1.png)
:::

::: column
-   Divide over EU integration and immigration policies
-   Divide over degree of protection and liberalization of protected sectors
:::
:::
