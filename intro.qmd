...
However, other data sources show a more contrasted picture of Switzerland's political stability. The *VOX* studies, which conducted post-ballot surveys after each referendum voting session, were harmonized in a cumulative dataset which offer long-run data from 1981 to 2016. A similar figure as @fig-trust1 can thus be made with a precise focus on Switzerland:
